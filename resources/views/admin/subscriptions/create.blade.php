        ...
        <form action="{{ route('subscriptions.store') }}" method="post">
            ...
            <div class="flex-align-center flex-col sm:flex-row gap-4 mt-4">
                ...
                <div class="flex-1 w-full sm:w-fit">
                    ...
                    <input type="number" class="input-admin" name="amount_received" value="{{old('amount_received')}}"
                ...
                <div class="flex-1 w-full sm:w-fit">
                    ...
                    <input type="number" class="input-admin" name="amount_pending" value="{{old('amount_pending')}}"
            ...
            <div class="flex justify-end">
                <button class="btn btn-primary mt-4">Add Subscription</button>
            </div>
        </form>
    </div>
</x-admin-layout>